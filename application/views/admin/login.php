				...
				<form class="form-signin style-4" method="POST" role="form">
					...
					<div class="form-group">
						<div class="input-group">
							...
							<input id="inputEmail" name="admin_email" class="form-control no-border" placeholder="ADRESA DE EMAIL" required="" autofocus="" type="email">
						</div>
					</div>
					<div class="form-group">
						<div class="input-group">
							...
							<input id="inputPassword" name="admin_pass" class="form-control no-border" placeholder="PAROLA" type="password" required>
						</div>
					</div>
